    ...
    constructor() {
     ...
     preload(){
      ...
      this.load.image('clouds', 'assets/clouds.png')
        ...
        create() {
          ...
          gameState.sky = this.add.image(0, 0,'background1').setOrigin(0).setScrollFactor(.05).setDepth(-.5)//.setScale(.6);
     ...
     /* this.physics.add.collider(gameState.bird, gameState.teleporter, () => {
      ...
      gameState.shift = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.SHIFT);
       ...
       if(gameState.bird.x >= 430 && gameState.bird.x <= 660){
        ...
        if(gameState.bird.x >= 690 && gameState.bird.x <= 940){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 1000 && gameState.bird.x <= 1200){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 1300 && gameState.bird.x <= 1400){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 1600 && gameState.bird.x <= 1700){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 1800 && gameState.bird.x <= 2000){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100 && gameState.bird.x <= 2000+275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+275 && gameState.bird.x <= 2000+2*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+2*275 && gameState.bird.x <= 2000+3*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+3*275 && gameState.bird.x <= 2000+4*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+4*275 && gameState.bird.x <= 2000+5*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+5*275 && gameState.bird.x <= 2000+6*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+6*275 && gameState.bird.x <= 2000+7*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+7*275 && gameState.bird.x <= 2000+8*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+8*275 && gameState.bird.x <= 2000+9*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+9*275 && gameState.bird.x <= 2000+10*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+10*275 && gameState.bird.x <= 2000+11*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+11*275 && gameState.bird.x <= 2000+12*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+12*275 && gameState.bird.x <= 2000+13*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+13*275 && gameState.bird.x <= 2000+14*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+14*275 && gameState.bird.x <= 2000+15*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+15*275 && gameState.bird.x <= 2000+16*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+16*275 && gameState.bird.x <= 2000+17*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+17*275 && gameState.bird.x <= 2000+18*275){
          gameState.score = Math.round(gameState.score);
        }
        ...
        if(gameState.bird.x >= 2100+18*275 && gameState.bird.x <= 2000+19*275){
          gameState.score = Math.round(gameState.score);
        }
       ...
       if(gameState.bird.x >= 2100+19*275 && gameState.bird.x <= 2000+20*275){
        gameState.score = Math.round(gameState.score);
      }
